...
$fecha = ($_POST['fecha']) ? clearDate($_POST['fecha']) : date('Ymd');
$caja = ($_POST['caja']) ? $_POST['caja'] :'01';
$turno = ($_POST['turno']) ? $_POST['turno'] :'1';


$query = Comando::recordSet($pdo,
"SELECT * FROM IVBDHEPE  WHERE  he_tipfac!='' AND HE_FECHA = '{$fecha}' AND HE_CAJA='{$caja}' AND HE_TURNO = '{$turno}' ");
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-2 text-center">
                    ...
                    <input type="text" name="fecha" class="form-control date" value="<?=date('d/m/Y')?>">
            </div>
            <div class="col-md-2 text-center">
                    <label for="">Caja</label>
                    <select name="caja" id="caja" class="form-control">
                    <?php for($i=1;$i<=12;$i++):?>
                        <option value="<?=getNumeroConCero($i)?>"><?=getNumeroConCero($i)?></option>
                    <?php endfor;?>
                    </select>
            </div>
            <div class="col-md-2 text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><p style="padding-top:13px;">RD$ <?=number_format($egresos[0]['Egresos'],2)?>
                                    <a href="" class="btn btn-primary btn-sm pull-right"> <i class="fa fa-eye"></i> </a>
                                </p></td>
                            </tr>
                            <tr>
